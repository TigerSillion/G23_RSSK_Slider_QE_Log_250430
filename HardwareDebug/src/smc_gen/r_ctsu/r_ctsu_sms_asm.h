 ...
 * assembled at Wed Apr 30 23:54:17 2025
 */
...
#define SIZEOF_sms_init_program (3)

#define sms_init_program \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04  /*  2: WHILE1  [SMSG13+4].0 */

#define SIZEOF_sms_prog_page1 (32)

#define sms_prog_page1 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
        0x3360, /*  3: MOVW    SMSG6, [SMSG3+0] */ \
        0x4640, /*  4: SET1    [SMSG6+0].4 */ \
        0x3366, /*  5: MOVW    SMSG6, [SMSG3+6] */ \
        0x3670, /*  6: MOVW    SMSG7, [SMSG6+0] */ \
        0x2b70, /*  7: MOVW    [SMSG11+0], SMSG7 */ \
        0x3352, /*  8: MOVW    SMSG5, [SMSG3+2] */ \
        0x3364, /*  9: MOVW    SMSG6, [SMSG3+4] */ \
        0x36c2, /* 10: MOVW    SMSG12, [SMSG6+2] */ \
        0x7651, /* 11: SUBW    SMSG6, SMSG5 */ \
        0x3692, /* 12: MOVW    SMSG9, [SMSG6+2] */ \
        0x7972, /* 13: CMPW    SMSG9, SMSG7 */ \
        0x8020, /* 14: BC      $2 */ \
        0x8fc3, /* 15: BNZ     $-4 */ \
        0x3686, /* 16: MOVW    SMSG8, [SMSG6+6] */ \
        0x7791, /* 17: SUBW    SMSG7, SMSG9 */ \
        0x7891, /* 18: SUBW    SMSG8, SMSG9 */ \
        0x3290, /* 19: MOVW    SMSG9, [SMSG2+0] */ \
        0x3410, /* 20: MOVW    SMSG1, [SMSG4+0] */ \
        0x7990, /* 21: ADDW    SMSG9, SMSG9 */ \
        0x7782, /* 22: CMPW    SMSG7, SMSG8 */ \
        0x8030, /* 23: BC      $3 */ \
        0x7781, /* 24: SUBW    SMSG7, SMSG8 */ \
        0x79e0, /* 25: ADDW    SMSG9, SMSG14 */ \
        0x7770, /* 26: ADDW    SMSG7, SMSG7 */ \
        0x71e1, /* 27: SUBW    SMSG1, SMSG14 */ \
        0x8f93, /* 28: BNZ     $-7 */ \
        0x3680, /* 29: MOVW    SMSG8, [SMSG6+0] */ \
        0x7ff2, /* 30: CMPW    SMSG15, SMSG15 */ \
        0x8e12  /* 31: BZ      $-31 */

#define SIZEOF_sms_prog_page2 (32)

#define sms_prog_page2 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
        ...
        0x2286, /* 28: MOVW    [SMSG2+6], SMSG8 */ \
        0x3280, /* 29: MOVW    SMSG8, [SMSG2+0] */ \
        0x7ff2, /* 30: CMPW    SMSG15, SMSG15 */ \
        0x8e12  /* 31: BZ      $-31 */

#define SIZEOF_sms_prog_page3 (32)

#define sms_prog_page3 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
...
#define SIZEOF_sms_prog_page4 (32)

#define sms_prog_page4 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
...
#define SIZEOF_sms_prog_page5 (32)

#define sms_prog_page5 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
...
#define SIZEOF_sms_prog_page6 (32)

#define sms_prog_page6 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
...
#define SIZEOF_sms_prog_page7 (32)

#define sms_prog_page7 \
        0x2df4, /*  0: MOVW    [SMSG13+4], SMSG15 */ \
        0xf002, /*  1: DTCTRG */ \
        0xad04, /*  2: WHILE1  [SMSG13+4].0 */ \
        0x3250, /*  3: MOVW    SMSG5, [SMSG2+0] */ \
        0x3272, /*  4: MOVW    SMSG7, [SMSG2+2] */ \
        0x2574, /*  5: MOVW    [SMSG5+4], SMSG7 */ \
        0x3274, /*  6: MOVW    SMSG7, [SMSG2+4] */ \
        0x2572, /*  7: MOVW    [SMSG5+2], SMSG7 */ \
        0x7c02, /*  8: CMPW    SMSG12, SMSG0 */ \
        0x8163, /*  9: BNZ     $22 */ \
        0x33a4, /* 10: MOVW    SMSG10, [SMSG3+4] */ \
        0x33b6, /* 11: MOVW    SMSG11, [SMSG3+6] */ \
        0x3494, /* 12: MOVW    SMSG9, [SMSG4+4] */ \
        0x5920, /* 13: CLR1    [SMSG9+0].2 */ \
        0x4920, /* 14: SET1    [SMSG9+0].2 */ \
        0x7603, /* 15: SHRW    SMSG6 */ \
        0x7960, /* 16: ADDW    SMSG9, SMSG6 */ \
        0x3486, /* 17: MOVW    SMSG8, [SMSG4+6] */ \
        0x2980, /* 18: MOVW    [SMSG9+0], SMSG8 */ \
        0x3452, /* 19: MOVW    SMSG5, [SMSG4+2] */ \
        0x3286, /* 20: MOVW    SMSG8, [SMSG2+6] */ \
        0x0580, /* 21: MOV     [SMSG5+0], SMSG8 */ \
        0x3490, /* 22: MOVW    SMSG9, [SMSG4+0] */ \
        0x6970, /* 23: MOV1    SCY, [SMSG9+0].7 */ \
        0x8030, /* 24: BC      $3 */ \
        0x6170, /* 25: MOV1    SCY, [SMSG1+0].7 */ \
        0x8051, /* 26: BNC     $5 */ \
        0x5170, /* 27: CLR1    [SMSG1+0].7 */ \
        0x7260, /* 28: ADDW    SMSG2, SMSG6 */ \
        0x3260, /* 29: MOVW    SMSG6, [SMSG2+0] */ \
        0x5640, /* 30: CLR1    [SMSG6+0].4 */ \
        0xf000  /* 31: FINISH */
