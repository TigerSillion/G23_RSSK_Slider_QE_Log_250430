...
*/
/* Reset control of timer array unit 1 (TAU1RES) */
#define _00_TAU1_RESET_RELEASE            (0x00U)    /* unreset */
#define _02_TAU1_RESET_SET                (0x02U)    /* reset */
...
#define _02_TAU_CH7_RXD2_INPUT            (0x02U)    /* input signal of RxD2 pin is used as timer input */
/* External interrupt (INTP0) input switching(ISC0) */
#define _00_EXTERNAL_INTP0_INPUT          (0x00U)    /* input signal of the INTP0 is used as external interrupt input*/
#define _01_EXTERNAL_RXD2_INPUT           (0x01U)    /* input signal of RxD2 pin is used as external interrupt input */
