...
Pragma directive
***********************************************************************************************************************/
#pragma interrupt r_Config_UARTA1_interrupt_send(vect=INTUT1)
...
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_UARTA1_interrupt_send(void)
{
    ...
    else if (0U != (ASIMA10 & _02_UARTA_BUFFER_EMPTY))
    {
        ISSMA1 = 0U;
    }
    else
